...
local AddressLookupEntity = {}
AddressLookupEntity.__index = AddressLookupEntity


function AddressLookupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AddressLookupEntity)
  self._name = "address_lookup"
  self._client = client
...
function AddressLookupEntity:get_name()
  return self._name
end


function AddressLookupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AddressLookupEntity.new(self._client, opts)
end
...
function AddressLookupEntity:mark_deleted()
  self._deleted = true
end


function AddressLookupEntity:deleted()
  return true == self._deleted
end


function AddressLookupEntity:data_set(args)
  if args ~= nil then
...
function AddressLookupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AddressLookupEntity:match_set(args)
  if args ~= nil then
...
function AddressLookupEntity:match_get()
...
function AddressLookupEntity:stream(action, args, callopts)
...
---@param reqmatch AddressLookupListMatch
---@param ctrl? table
---@return AddressLookup[]
---@return string? err
function AddressLookupEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AddressLookupEntity:_run_op(ctx, post_done)
  local utility = self._utility
