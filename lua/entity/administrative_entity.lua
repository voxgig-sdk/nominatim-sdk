...
local AdministrativeEntity = {}
AdministrativeEntity.__index = AdministrativeEntity


function AdministrativeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AdministrativeEntity)
  self._name = "administrative"
  self._client = client
...
function AdministrativeEntity:get_name()
  return self._name
end


function AdministrativeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AdministrativeEntity.new(self._client, opts)
end
...
function AdministrativeEntity:mark_deleted()
  self._deleted = true
end


function AdministrativeEntity:deleted()
  return true == self._deleted
end


function AdministrativeEntity:data_set(args)
  if args ~= nil then
...
function AdministrativeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AdministrativeEntity:match_set(args)
  if args ~= nil then
...
function AdministrativeEntity:match_get()
...
function AdministrativeEntity:stream(action, args, callopts)
...
function AdministrativeEntity:_run_op(ctx, post_done)
  local utility = self._utility
