...
local DebugEntity = {}
DebugEntity.__index = DebugEntity


function DebugEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DebugEntity)
  self._name = "debug"
  self._client = client
...
function DebugEntity:get_name()
  return self._name
end


function DebugEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DebugEntity.new(self._client, opts)
end
...
function DebugEntity:mark_deleted()
  self._deleted = true
end


function DebugEntity:deleted()
  return true == self._deleted
end


function DebugEntity:data_set(args)
  if args ~= nil then
...
function DebugEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DebugEntity:match_set(args)
  if args ~= nil then
...
function DebugEntity:match_get()
...
function DebugEntity:stream(action, args, callopts)
...
function DebugEntity:_run_op(ctx, post_done)
  local utility = self._utility
