...
describe("AddressLookupDirect", function()
  it("should direct-list-address_lookup", function()
    local setup = address_lookup_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-address_lookup", setup.live and "live" or "unit")
