...
local SDK_MODULE = "nominatim_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["address_lookup"] = { ["test01"] = { id = "test01" } }, ["administrative"] = { ["test01"] = { id = "test01" } }, ["debug"] = { ["test01"] = { id = "test01" } }, ["reverse"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["server_status"] = { ["test01"] = { id = "test01" } } } }'
