...
describe("AdministrativeDirect", function()
  it("should direct-list-administrative", function()
    local setup = administrative_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-administrative", setup.live and "live" or "unit")
