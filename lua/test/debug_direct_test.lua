...
describe("DebugDirect", function()
  it("should direct-load-debug", function()
    local setup = debug_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-debug", setup.live and "live" or "unit")
