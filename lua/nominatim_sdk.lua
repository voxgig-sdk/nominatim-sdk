...
local NominatimSDK = {}
NominatimSDK.__index = NominatimSDK
...
NominatimSDK._make_feature = _make_feature


function NominatimSDK.new(options)
  local self = setmetatable({}, NominatimSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function NominatimSDK:options_map()
...
function NominatimSDK:get_utility()
  return Utility.copy(self._utility)
end


function NominatimSDK:get_root_ctx()
  return self._rootctx
end


function NominatimSDK:prepare(fetchargs)
...
function NominatimSDK:direct(fetchargs)
...
-- by passing it.
function NominatimSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function NominatimSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "NominatimSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function NominatimSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = NominatimSDK.new(sdkopts)
  sdk.mode = "test"
