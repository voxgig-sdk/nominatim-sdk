...
class AdministrativeEntity
  ...
  def make
    opts = @_entopts.dup
    AdministrativeEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [AdministrativeListMatch, Hash, nil] match filter (any subset of
  #   Administrative fields); defaults to nil, treated as an empty match that lists all.
