...
module NominatimTestRunner
  ...
  def self.env_override(m)
    live = getenv("NOMINATIM_TEST_LIVE")
    override = getenv("NOMINATIM_TEST_OVERRIDE")
    ...
    explain = getenv("NOMINATIM_TEST_EXPLAIN")
    m["NOMINATIM_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NominatimTestRunner
Helpers = NominatimHelpers
Vs = VoxgigStruct
