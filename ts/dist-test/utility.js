...
function envOverride(m) {
    if ('TRUE' === process.env.NOMINATIM_TEST_LIVE ||
        'TRUE' === process.env.NOMINATIM_TEST_OVERRIDE) {
    ...
    m.NOMINATIM_TEST_EXPLAIN = process.env.NOMINATIM_TEST_EXPLAIN || m.NOMINATIM_TEST_EXPLAIN;
    return m;
}
