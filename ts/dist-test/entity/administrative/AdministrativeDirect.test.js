...
(0, node_test_1.describe)('AdministrativeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NominatimSDK({
    ...
    (0, node_test_1.test)('direct-list-administrative', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-administrative', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NominatimSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['NOMINATIM_TEST_ADMINISTRATIVE_ENTID'];
    ...
    const client = new __1.NominatimSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AdministrativeDirect.test.js.map