...
(0, node_test_1.describe)('AddressLookupDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-address_lookup', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-address_lookup', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOMINATIM_TEST_ADDRESS_LOOKUP_ENTID'];
...
//# sourceMappingURL=AddressLookupDirect.test.js.map