...
(0, node_test_1.describe)('SearchEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set NOMINATIM_TEST_SEARCH_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['NOMINATIM_TEST_SEARCH_ENTID'];
    ...
    idmap = env['NOMINATIM_TEST_SEARCH_ENTID'];
