...
(0, node_test_1.describe)('ServerStatusDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-server_status', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-server_status', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOMINATIM_TEST_SERVER_STATUS_ENTID'];
...
//# sourceMappingURL=ServerStatusDirect.test.js.map