...
(0, node_test_1.describe)('DebugEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'debug.' + op, live))
                return;
        }
        ...
        let debug_ref01_data = Object.values(setup.data.existing.debug)[0];
        // LOAD
        const debug_ref01_ent = client.Debug();
        const debug_ref01_match_dt0 = {};
        const debug_ref01_data_dt0 = (await debug_ref01_ent.load(debug_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != debug_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/debug/DebugTestData.json');
    ...
    let idmap = transform(['debug01', 'debug02', 'debug03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=DebugEntity.test.js.map