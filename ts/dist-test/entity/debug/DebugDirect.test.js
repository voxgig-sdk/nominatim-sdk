...
(0, node_test_1.describe)('DebugDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-debug', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-debug', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NOMINATIM_TEST_DEBUG_ENTID'];
...
//# sourceMappingURL=DebugDirect.test.js.map