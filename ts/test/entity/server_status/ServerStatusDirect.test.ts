...
describe('ServerStatusDirect', async () => {
  ...
  test('direct-load-server_status', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-server_status', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['NOMINATIM_TEST_SERVER_STATUS_ENTID']
