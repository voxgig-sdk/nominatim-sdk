...
describe('AdministrativeEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'administrative.' + op, live)) return
    }
    ...
    let administrative_ref01_data = Object.values(setup.data.existing.administrative)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/administrative/AdministrativeTestData.json')
