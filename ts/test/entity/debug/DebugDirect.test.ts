...
describe('DebugDirect', async () => {
  ...
  test('direct-load-debug', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-debug', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['NOMINATIM_TEST_DEBUG_ENTID']
