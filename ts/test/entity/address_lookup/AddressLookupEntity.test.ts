...
describe('AddressLookupEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'address_lookup.' + op, live)) return
    }
    ...
    let address_lookup_ref01_data = Object.values(setup.data.existing.address_lookup)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/address_lookup/AddressLookupTestData.json')
