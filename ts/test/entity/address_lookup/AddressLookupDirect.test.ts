...
describe('AddressLookupDirect', async () => {
  ...
  test('direct-list-address_lookup', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-address_lookup', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['NOMINATIM_TEST_ADDRESS_LOOKUP_ENTID']
