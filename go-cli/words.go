...
func registerSDKWords(r *eng.Registry, client *sdk.NominatimSDK) {
...
func runOp(client *sdk.NominatimSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
