# Nominatim SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NominatimSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NominatimSDK(...) and NominatimSDK.test(...) become
#      NominatimSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nominatim_sdk"
_SDK_CLASS = "NominatimSDK"
