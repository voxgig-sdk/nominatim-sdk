...
class TestAddressLookupEntity:
    ...
    def test_should_stream(self):
        ...
        seen = list(base.AddressLookup(None).stream("list", None, None))
        assert len(seen) == 3
        ...
        if isinstance(cfg.get("feature"), dict) and "streaming" in cfg["feature"]:
            ...
            got = []
            for item in sdk.AddressLookup(None).stream("list", None, None):
    ...
    def test_should_run_basic_flow(self):
        ...
        address_lookup_ref01_list_result = address_lookup_ref01_ent.list(address_lookup_ref01_match, None)
