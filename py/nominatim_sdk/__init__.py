...
from nominatim_sdk.utility import register

# Load features
from nominatim_sdk.feature.base_feature import NominatimBaseFeature
from nominatim_sdk.features import _has_feature, _make_feature
...
class NominatimSDK:
    ...
    def get_utility(self):
        return NominatimUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "NominatimSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NominatimSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def AddressLookup(self, data=None) -> "AddressLookupEntity":
        ...
        from nominatim_sdk.entity.address_lookup_entity import AddressLookupEntity
    ...
    def Administrative(self, data=None) -> "AdministrativeEntity":
        ...
        from nominatim_sdk.entity.administrative_entity import AdministrativeEntity
    ...
    def Debug(self, data=None) -> "DebugEntity":
        ...
        from nominatim_sdk.entity.debug_entity import DebugEntity
    ...
    def Reverse(self, data=None) -> "ReverseEntity":
        ...
        from nominatim_sdk.entity.reverse_entity import ReverseEntity
        return ReverseEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from nominatim_sdk.entity.search_entity import SearchEntity
    ...
    def ServerStatus(self, data=None) -> "ServerStatusEntity":
        ...
        from nominatim_sdk.entity.server_status_entity import ServerStatusEntity
