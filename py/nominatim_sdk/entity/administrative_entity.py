...
class AdministrativeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdministrativeEntity(self._client, opts)
    ...
    def data_get(self) -> Administrative:
    ...
    def match_get(self) -> Administrative:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Administrative]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Administrative().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
