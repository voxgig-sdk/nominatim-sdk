...
from nominatim_sdk.nominatim_types import (
    AddressLookup,
    AddressLookupListMatch,
)
...
class AddressLookupEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AddressLookupEntity(self._client, opts)
    ...
    def data_get(self) -> AddressLookup:
    ...
    def match_get(self) -> AddressLookup:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AddressLookup]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AddressLookup().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
