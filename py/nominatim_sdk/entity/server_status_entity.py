...
class ServerStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ServerStatusEntity(self._client, opts)
    ...
    def data_get(self) -> ServerStatus:
    ...
    def match_get(self) -> ServerStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ServerStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ServerStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
