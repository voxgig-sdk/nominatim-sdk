...
|---|---|---|
| `ts/` | @voxgig-sdk/nominatim-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nominatim-sdk \
      --repository voxgig-sdk/nominatim-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nominatim-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nominatim-sdk --id=<id>` removes it.
