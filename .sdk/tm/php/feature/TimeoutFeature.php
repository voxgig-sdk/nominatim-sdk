...
class NominatimTimeoutFeature extends NominatimBaseFeature
{
    ...
    private function _with_timeout(NominatimContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NominatimContext $_ctx, float $ms): void
    {
        $client = $this->client;
