...
// Nominatim SDK ratelimit feature
...
class NominatimRatelimitFeature extends NominatimBaseFeature
{
    ...
    private function _acquire(NominatimContext $ctx): void
    {
    ...
    private function _track(NominatimContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
