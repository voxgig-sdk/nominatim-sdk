...
class NominatimGraphql
{
    ...
    // equivalent.
    public static function body(NominatimContext $ctx): mixed
    {
    ...
    public static function errors(NominatimContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
