...
class NominatimFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NominatimSDK/1.0)';
    ...
    public static function call(NominatimContext $ctx, string $fullurl, array $fetchdef): array
    {
