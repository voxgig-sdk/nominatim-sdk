...
// Nominatim SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NominatimMakeRequest
{
    public static function call(NominatimContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NominatimResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NominatimResponse($fetched);
        } else {
