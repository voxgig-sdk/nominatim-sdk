...
The PHP SDK for the Nominatim API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->AddressLookup(null)->list(null, null);
...
[$result, $err] = $client->Nominatim(null)->load(
    ["id" => "test01"], null
);
