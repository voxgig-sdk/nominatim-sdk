...
class NominatimProxyFeature extends NominatimBaseFeature
{
    ...
    public function init(NominatimContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NominatimContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
