...
class NominatimCacheFeature extends NominatimBaseFeature
{
    ...
    private function _through(NominatimContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
