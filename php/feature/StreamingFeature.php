...
// Nominatim SDK streaming feature
...
class NominatimStreamingFeature extends NominatimBaseFeature
{
    ...
    private function _iterate(NominatimResult $result): \Generator
    {
    ...
    private function _streamable(NominatimContext $ctx): bool
    {
