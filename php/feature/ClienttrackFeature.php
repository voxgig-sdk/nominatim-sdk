...
// Nominatim SDK clienttrack feature
...
class NominatimClienttrackFeature extends NominatimBaseFeature
{
    ...
    public function PostConstruct(NominatimContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Nominatim-SDK';
