...
class NominatimRbacFeature extends NominatimBaseFeature
{
    ...
    private function _required(NominatimContext $ctx): ?string
    {
    ...
    private function _reject(NominatimContext $ctx, string $required): void
    {
    ...
    private function _track(NominatimContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
