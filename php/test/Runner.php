...
class NominatimTestRunner
{
    ...
    {
        $live = self::getenv('NOMINATIM_TEST_LIVE');
        $override = self::getenv('NOMINATIM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NOMINATIM_TEST_EXPLAIN');
...
class_alias('NominatimTestRunner', 'Runner');
class_alias('NominatimHelpers', 'Helpers');
