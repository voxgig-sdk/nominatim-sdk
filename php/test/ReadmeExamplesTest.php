...
// Nominatim SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NominatimSDK::test)
...
{
    private const SDK_CLASS = 'NominatimSDK';
    ...
    private const SDK_BASE = 'nominatim_sdk';
