...
// Nominatim SDK Administrative entity
...
class AdministrativeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdministrativeEntity($this->_client, $opts);
    }

    /**
     * @param Administrative|array $args Administrative data (assoc-array) to store.
     */
    ...
    /**
     * @return Administrative|array The current Administrative data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Administrative fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Administrative fields).
     */
     ...
     *
     * @param AdministrativeListMatch|array|null $reqmatch Match filter (any subset
     *   of Administrative fields) as an assoc-array; AdministrativeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Administrative[]|array A list of Administrative items as assoc-arrays at
