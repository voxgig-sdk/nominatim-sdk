...
// Nominatim SDK ServerStatus entity
...
class ServerStatusEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ServerStatusEntity($this->_client, $opts);
    }

    /**
     * @param ServerStatus|array $args ServerStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return ServerStatus|array The current ServerStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ServerStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ServerStatus fields).
     */
     ...
     *
     * @param ServerStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ServerStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ServerStatus|array The loaded ServerStatus as an assoc-array at the
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = NominatimHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
