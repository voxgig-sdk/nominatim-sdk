...
// Nominatim SDK AddressLookup entity
...
class AddressLookupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AddressLookupEntity($this->_client, $opts);
    }

    /**
     * @param AddressLookup|array $args AddressLookup data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = NominatimHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return AddressLookup|array The current AddressLookup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AddressLookup fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = NominatimHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of AddressLookup fields).
     */
    ...
    /**
     * List AddressLookup items matching the given filter.
     *
     * @param AddressLookupListMatch|array|null $reqmatch Match filter (any subset
     *   of AddressLookup fields) as an assoc-array; AddressLookupListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AddressLookup[]|array A list of AddressLookup items as assoc-arrays at
