...
const testSeed = `map[string]any{"entity": map[string]any{"address_lookup": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "administrative": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "debug": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reverse": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "server_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
