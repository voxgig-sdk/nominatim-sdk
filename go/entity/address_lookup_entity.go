...
type AddressLookupEntity struct {
	name    string
	client  *core.NominatimSDK
...
func NewAddressLookupEntity(client *core.NominatimSDK, entopts map[string]any) *AddressLookupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AddressLookupEntity) GetName() string { return e.name }
...
func (e *AddressLookupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AddressLookupEntity) Deleted() bool {
	return e.deleted
}


func (e *AddressLookupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAddressLookupEntity(e.client, opts)
}

func (e *AddressLookupEntity) Data(args ...any) any {
...
func (e *AddressLookupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AddressLookup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AddressLookupEntity) DataTyped(data ...AddressLookup) AddressLookup {
	if len(data) > 0 {
		return typedFrom[AddressLookup](e.Data(asMap(data[0])))
	}
	return typedFrom[AddressLookup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AddressLookup (all fields
// optional at the wire level).
func (e *AddressLookupEntity) MatchTyped(match ...AddressLookup) AddressLookup {
	if len(match) > 0 {
		return typedFrom[AddressLookup](e.Match(asMap(match[0])))
	}
	return typedFrom[AddressLookup](e.Match())
}
...
func (e *AddressLookupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AddressLookupEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AddressLookupEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AddressLookupListMatch and returns []AddressLookup. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AddressLookupEntity) ListTyped(reqmatch AddressLookupListMatch, ctrl map[string]any) ([]AddressLookup, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AddressLookup](res), nil
}



func (e *AddressLookupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AddressLookupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AddressLookupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AddressLookupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
