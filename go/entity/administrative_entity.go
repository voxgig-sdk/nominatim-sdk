...
type AdministrativeEntity struct {
	name    string
...
func NewAdministrativeEntity(client *core.NominatimSDK, entopts map[string]any) *AdministrativeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdministrativeEntity) GetName() string { return e.name }
...
func (e *AdministrativeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdministrativeEntity) Deleted() bool {
	return e.deleted
}


func (e *AdministrativeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdministrativeEntity(e.client, opts)
}

func (e *AdministrativeEntity) Data(args ...any) any {
...
func (e *AdministrativeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AdministrativeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdministrativeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *AdministrativeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdministrativeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdministrativeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdministrativeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
