...
func NewServerStatusEntity(client *core.NominatimSDK, entopts map[string]any) *ServerStatusEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ServerStatusEntity) GetName() string { return e.name }
...
func (e *ServerStatusEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ServerStatusEntity) Deleted() bool {
	return e.deleted
}


func (e *ServerStatusEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewServerStatusEntity(e.client, opts)
}

func (e *ServerStatusEntity) Data(args ...any) any {
...
func (e *ServerStatusEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ServerStatus; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ServerStatusEntity) DataTyped(data ...ServerStatus) ServerStatus {
	if len(data) > 0 {
		return typedFrom[ServerStatus](e.Data(asMap(data[0])))
	}
	return typedFrom[ServerStatus](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ServerStatus (all fields
// optional at the wire level).
func (e *ServerStatusEntity) MatchTyped(match ...ServerStatus) ServerStatus {
	if len(match) > 0 {
		return typedFrom[ServerStatus](e.Match(asMap(match[0])))
	}
	return typedFrom[ServerStatus](e.Match())
}
...
func (e *ServerStatusEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ServerStatusEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ServerStatusLoadMatch and returns an ServerStatus. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ServerStatusEntity) LoadTyped(reqmatch ServerStatusLoadMatch, ctrl map[string]any) (ServerStatus, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ServerStatus{}, err
	}
	return typedFrom[ServerStatus](res), nil
}



func (e *ServerStatusEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ServerStatusEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ServerStatusEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ServerStatusEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ServerStatusEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
