...
func NewDebugEntity(client *core.NominatimSDK, entopts map[string]any) *DebugEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DebugEntity) GetName() string { return e.name }
...
func (e *DebugEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DebugEntity) Deleted() bool {
	return e.deleted
}


func (e *DebugEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDebugEntity(e.client, opts)
}

func (e *DebugEntity) Data(args ...any) any {
...
func (e *DebugEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Debug; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DebugEntity) DataTyped(data ...Debug) Debug {
	if len(data) > 0 {
		return typedFrom[Debug](e.Data(asMap(data[0])))
	}
	return typedFrom[Debug](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Debug (all fields
// optional at the wire level).
func (e *DebugEntity) MatchTyped(match ...Debug) Debug {
	if len(match) > 0 {
		return typedFrom[Debug](e.Match(asMap(match[0])))
	}
	return typedFrom[Debug](e.Match())
}
...
func (e *DebugEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DebugEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DebugLoadMatch and returns an Debug. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DebugEntity) LoadTyped(reqmatch DebugLoadMatch, ctrl map[string]any) (Debug, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Debug{}, err
	}
	return typedFrom[Debug](res), nil
}



func (e *DebugEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DebugEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DebugEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DebugEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DebugEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
